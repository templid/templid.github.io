...
export default {
    ...
    setup() {
        onMounted(() => {
            const clientId = 'AepKyjnfohzWThco-zu-L0rHvsrFc1RoZO2BfuHZor-vIcQLjpR2mTxvriuyRZUxVAOz77sfzI3IKY8e'
            ...
            function initPayPalButton() {
                ...
                paypal.Buttons({
                    ...
                    onClick: function() {
                        ...
                        purchaseName = (<HTMLInputElement>document.querySelector('#form-name')).value;
                        purchaseEmail = (<HTMLInputElement>document.querySelector('#form-email')).value;
                    ...
                    onApprove: function(data: any, actions: any) {
                        return actions.order.capture().then(function(orderData: any) {
                            ...
                            const element = document.getElementById('paypal-button-container') ?? document.createElement('div');
